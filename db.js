window.App.startNewChat = async function() {
    ...
    if (!window.App.state.activeCharacter || window.App.state.activeCharacter.mode !== currentMode) {
        window.App.state.activeCharacter = window.App.BASE_PERSONAS[currentMode];
    }
